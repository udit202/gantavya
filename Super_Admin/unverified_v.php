<?php
require 'db.php';
$sql = "SELECT * FROM `wp_vehicles` Where `is_verified`=0";
$result = mysqli_query($conn, $sql);
$num = mysqli_num_rows($result);
echo $num;
$no = 1;
?>
<table id="UnVerified_Vechles" class="display" style="padding:20px">
    <thead>
        <tr>
            <th>
                NO.
    ...
    <td>
    <button class='verify_vechle btn btn-outline-success'>Verify</button>
    </td>
</tr>"
                ;
                $no++;
